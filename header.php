            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse"
                    ...
                    <!-- <li class="dropdown-submenu">
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                                Tecn&oacute;logos M&eacute;dicos  <span class='label notseen label-danger top-right' style=' border-radius: 10px;'><?php if($context != "super") {$notseen= getNotSeen($_SESSION ["idusuario"]); if ($notseen >= 1){echo $notseen;} }?></span>
                                <span class="caret"></span>
                            </a>
                            <ul class="dropdown-menu" role="menu">
                                <li><a id="perfiles" href="Perfiles.php">Perfiles Tecn&oacute;logos M&eacute;dicos <span class='label notseen label-danger top-right' style=' border-radius: 10px;'><?php if($context != "super") {$notseen= getNotSeen($_SESSION ["idusuario"]); if ($notseen >= 1){echo $notseen;} }?></span></a>
                                </li>
                                <?php
                                if ($admin == 1) {
